        ...
        LiquidBottomTabs(
            ...
            LiquidBottomTab(
                ...
                Box(
                    Modifier
                        .size(28f.dp)
                        .paint(painterResource(com.example.keyboard.R.drawable.education), colorFilter = iconColorFilter)
                )
            }
            ...
            LiquidBottomTab(
                ...
                Box(
                    Modifier
                        .size(28f.dp)
                        .paint(painterResource(com.example.keyboard.R.drawable.settings), colorFilter = iconColorFilter)
                )
            }
        }
    }
